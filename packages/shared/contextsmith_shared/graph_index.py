...
from contextsmith_shared.models import GraphEdge, GraphNode, Resource, SourceSnapshot
...
def build_graph_index(session: Session, resource: Resource, snapshot: SourceSnapshot, docs: list[dict]) -> GraphBuildStats:
    ...
    This is intentionally not a full Graphify/LightRAG clone. It gives ContextSmith
