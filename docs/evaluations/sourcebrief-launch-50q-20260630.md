...
NEXT_PUBLIC_API_BASE_URL="http://127.0.0.1:${SOURCEBRIEF_API_PORT}" \
SOURCEBRIEF_CORS_ORIGINS="http://127.0.0.1:${SOURCEBRIEF_WEB_PORT},http://localhost:${SOURCEBRIEF_WEB_PORT}" \
