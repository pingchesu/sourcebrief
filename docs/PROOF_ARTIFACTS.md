...
| Screenshot-backed 50Q walkthrough | Full local startup/import/50Q/scenario mechanics proof with seven screenshots. | [`evaluations/sourcebrief-launch-50q-20260630.md`](evaluations/sourcebrief-launch-50q-20260630.md), [`assets/screenshots/launch-50q-20260630/`](assets/screenshots/launch-50q-20260630/) | Current #210 run captured from an isolated live local stack with session login, 50/50 mechanical pass, browser console/network transcript, and screenshot hashes. Semantic quality remains RISK. Historical 2026-06-27 run remains at [`evaluations/sourcebrief-launch-50q-20260627.md`](evaluations/sourcebrief-launch-50q-20260627.md). |
...
| SourceBrief 50Q walkthrough screenshots | Issue #210 / `a58b3b7` product commit, runner hardening in this PR | Isolated local Docker Compose stack, session login, random API/web ports | 2026-06-30 | Login `/login` -> Command Center `/` -> Settings `/config` -> Sources `/sources` -> Workbench `/workbench` -> Agent Profile `/agent-profile` -> generated eval report | 50/50 mechanical questions passed; browser console/network transcript recorded zero console errors, page errors, failed requests, and bad responses. This is not semantic-quality PASS; screenshot hashes are listed in [`evaluations/sourcebrief-launch-50q-20260630.md`](evaluations/sourcebrief-launch-50q-20260630.md). |
| SourceBrief 50Q launch walkthrough screenshots | Issue #141 / `abc4c71` | Local Docker Compose stack, session login, API `:18000`, web `:3105` | 2026-06-27 | Login `/login` -> Command Center `/` -> Settings `/config` -> Sources `/sources` -> Workbench `/workbench` -> Agent Profile `/agent-profile` -> generated eval report | Historical screenshot set; generated JSON report stays under ignored `artifacts/`. |
The current operation path for the 50Q walkthrough is documented in [`evaluations/sourcebrief-launch-50q-20260630.md`](evaluations/sourcebrief-launch-50q-20260630.md), including exact auth mode, isolated stack shape, predeclared thresholds, browser transcript summary, screenshot inventory hashes, and screenshot-by-screenshot proof links. The historical 2026-06-27 run remains useful as a prior artifact but is not current-candidate proof.
...
| Self-improvement product surface: overview, no-silent-mutation boundary, MVP smoke, redacted review history/artifact detail, and sleep dry-run. | [`docs/evaluations/self-improvement-browser-20260630/README.md`](evaluations/self-improvement-browser-20260630/README.md); PR #206 / `6babf67`; `make qa-smoke`; `tests/unit/test_self_improvement_mvp_product.py`; browser-origin CORS preflight in `scripts/launch_50q_walkthrough.py`. |
...
| Skill Export package example | Closed by [`evaluations/skill-export-20260630/README.md`](evaluations/skill-export-20260630/README.md): current local run generated, approved, leak-scanned, and downloaded a redacted package proof. | Keep package proof refreshed when Skill Export generation changes. |
