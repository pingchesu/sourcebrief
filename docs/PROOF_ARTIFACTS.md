...
| Screenshot-backed 50Q launch walkthrough | Full local startup/import/50Q/scenario proof with seven screenshots. | [`evaluations/sourcebrief-launch-50q-20260627.md`](evaluations/sourcebrief-launch-50q-20260627.md), [`assets/screenshots/launch-50q/`](assets/screenshots/launch-50q/) | Captured from a live local stack using `scripts/launch_50q_walkthrough.py`; screenshots inspected for tokens, raw UUIDs, and private paths. |
