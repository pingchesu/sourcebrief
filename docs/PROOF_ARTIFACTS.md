...
| Screenshot-backed 50Q launch walkthrough | Full local startup/import/50Q/scenario proof with seven screenshots. | [`evaluations/sourcebrief-launch-50q-20260630.md`](evaluations/sourcebrief-launch-50q-20260630.md), [`assets/screenshots/launch-50q-20260630/`](assets/screenshots/launch-50q-20260630/) | Current #210 run captured from an isolated live local stack with session login, 50/50 pass, browser console/network transcript, and screenshot hashes. Historical 2026-06-27 run remains at [`evaluations/sourcebrief-launch-50q-20260627.md`](evaluations/sourcebrief-launch-50q-20260627.md). |
...
| SourceBrief 50Q launch walkthrough screenshots | Issue #210 / `a58b3b7` product commit, runner hardening in this PR | Isolated local Docker Compose stack, session login, random API/web ports | 2026-06-30 | Login `/login` -> Command Center `/` -> Settings `/config` -> Sources `/sources` -> Workbench `/workbench` -> Agent Profile `/agent-profile` -> generated eval report | 50/50 questions passed; browser console/network transcript recorded zero console errors, page errors, failed requests, and bad responses; screenshot hashes are listed in [`evaluations/sourcebrief-launch-50q-20260630.md`](evaluations/sourcebrief-launch-50q-20260630.md). |
