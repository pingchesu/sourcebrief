...
def _agent_pack_public_description(description: str | None) -> str:
    return _agent_pack_public_text(description, "Generated SourceBrief remote repo agent.")
...
def _agent_pack_manifest_dict(
    ...
    public_name = _agent_pack_public_text(agent_name or project.name, f"SourceBrief Project {project.id}")
    return {
...
def _agent_pack_zip_files(manifest: Mapping[str, Any]) -> dict[str, str]:
    ...
    return {
        ...
        "sourcebrief-agent.yaml": _agent_pack_manifest_yaml(manifest),
